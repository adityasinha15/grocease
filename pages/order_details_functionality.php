...
?>						<tr class="rem1">
						...
						<td class="invert-image" style="width:25%;">
						    <a href="product.php?pid=<?php echo $p_id; ?>">
						        <img src="product_image/<?php echo $p_id;?>/<?php echo $img; ?>" alt=" " class="img-responsive"/>
						        </a>
						        </td>
						<td class="invert">
							 <div class="quantity"> 
						...
						<td class="invert"><?php echo (int)($discount+1);?>%</td>
							<div class="rem">
			...
			<div class="checkout-left">	
				<div class="col-md-4 checkout-left-basket">
					...
					?>
						...
						<?php
						$grand_total = $grand_total + $price_arr[$j]* $quantity_arr[$j] + $ship_charg;
						$save_total = $save_total + $save_arr[$j]*$quantity_arr[$j];
						?>
						
					<?php }?>
					<b><li> You Save<i>-</i> <span><?php echo $save_total;?></span></li></b>
					<b><li> Shipping Charge<i>-</i> <span><?php echo $ship_charg;?></span></li></b>
					<b><li> Grand Total<i>-</i> <span><?php echo $grand_total;?></span></li></b>
					</ul>
				</div>
				...
				<form action="shipment.php" method="get" class="creditly-card-form agileinfo_form">
									<section class="creditly-wrapper wthree, w3_agileits_wrapper">
										<div class="information-wrapper">
											...
											<input type="hidden" name="delivery_status" value="<?php echo $delivery_status; ?>" >
											<?php
											if($cancel_status!=0)
											{
											    
											?>
											<button class="submit check_out">Track your order</button>
											<?php
											}
											else
											{
											?>
											<button type="button" class="btn btn-danger">This order is canceled</button>
											<?php
											}
											?>
										</div>
