...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 26, 2018 at 11:55 AM
...
INSERT INTO `product` (`p_id`, `b_id`, `pname`, `mrp`, `selling_price`, `quantity`, `category`, `brand`, `pdesc`, `img1`, `img2`) VALUES
(1, 1, 'Mini Gun', 300, 299, 0, '', '', 'AbcdefghijklmnopqrstuvwxyzAbcdefghijklmnopqrstuvwxyzAbcdefghijklmnopqrstuvwxyzAbcdefghijklmnopqrstuvwxyzAbcdefghijklmnopqrstuvwxyzAbcdefghijklmnopqrstuvwxyz', '', ''),
(5, 122, 'Mi note 4', 11000, 6000, 0, '10', '2', 'abaahgabaahgabaahgabaahgabaahgabaahgabaahgabaahgabaahgabaahgabaahgabaahgabaahgabaahgabaahgabaahgabaahgabaahgabaahgabaahgabaahgabaahgabaahgabaahgabaahgabaahg', 'Screenshot (1).png', 'Screenshot (2).png'),
(6, 122, 'Mi note 5 pro', 14000, 10000, 0, '10', '2', 'uyifvliugyvtcyghjbkuyuyifvliugyvtcyghjbkuyuyifvliugyvtcyghjbkuyuyifvliugyvtcyghjbkuyuyifvliugyvtcyghjbkuyuyifvliugyvtcyghjbkuyuyifvliugyvtcyghjbkuyuyifvliugyvtcyghjbkuyuyifvliugyvtcyghjbkuy', 'Screenshot (5).png', 'Screenshot (6).png'),
(7, 123, 'Laptop', 67665, 67600, 0, '', '', 'cfhgtdghjgyurfhgcfhgtdghjgyurfhgcfhgtdghjgyurfhgcfhgtdghjgyurfhgcfhgtdghjgyurfhgcfhgtdghjgyurfhgcfhgtdghjgyurfhgcfhgtdghjgyurfhgcfhgtdghjgyurfhgcfhgtdghjgyurfhgcfhgtdghjgyurfh', '15590886_229689914123898_7696347444090674459_o.jpg', 'Screenshot (1).png'),
(8, 124, 'LED Tv', 39000, 36000, 5, '10', '1', 'very good Tv', '', ''),
(9, 124, 'ac', 32000, 30000, 0, '', '', 'ygli', 'Screenshot (1).png', 'Screenshot (3).png'),
(10, 124, 'ac', 32000, 30000, 0, '', '', 'ygli', '', ''),
(11, 124, 'jg', 6876, 866, 0, '', '', '86r9tfugbhj', 'Screenshot (2).png', 'Screenshot (1).png'),
(12, 124, 'jg', 6876, 866, 0, '', '', '86r9tfugbhj', '', ''),
(13, 124, 'Redmi 4`', 10000, 9000, 4, '10', '2', 'tdrygjgvj', 'Screenshot (1).png', 'Screenshot (2).png'),
(14, 124, 'Ac', 38000, 35000, 88, '0', '1', 'uyhjkglj', '', ''),
(15, 124, 'ou', 68, 86, 86, '0', '0', 'yigfhtiyfhk', 'Screenshot (1).png', 'Screenshot (2).png'),
(16, 124, 'New2', 5000, 4000, 50, '10', '3', 'Ggsvsvwvevvsshshebd', '1540840674785677405584.jpg', '1540840690948215871510.jpg'),
(17, 125, 'ffufcjfc', 756856, 765465768, 574, '10', '2', 'douflidlutdutdlutsyrslutd', 'Screenshot (1).png', 'Screenshot (2).png'),
(18, 126, 'Iphone x', 124000, 123000, 20, '10', '1', 'Gggzgsvvsvsvsvwbwbww', 'IMG-20181101-WA0003.jpg', 'IMG-20181101-WA0002.jpg'),
(19, 127, 'vfiygcj', 57685768, 68, 56, '10', '2', 'kjvi;kflutduldutdlu5edtufit', 'Screenshot (6).png', 'Screenshot (3).png'),
(20, 127, 'fttuft', 75, 57, 5, '10', '1', 'kg9fyf;tddlutlduelutd5e5tue5e588ii6d5d', 'Screenshot (6).png', 'Screenshot (7).png'),
(21, 127, 'jhgyih', 7568565, 465, 85, '10', '1', 'gfot7doliykg;6fodi364ekyrjgfig96', 'Screenshot (8).png', 'Screenshot (7).png'),
(22, 127, '68tuiugily', 66, 6, 6, '10', '1', 'b;iyfilykhv57rskxyhgjuftd', 'Screenshot (2).png', 'Screenshot (1).png'),
(23, 127, 'ug8t', 867, 68, 765, '10', '1', 'u76r7tujhgjh6g57ryfhgg76r', 'Screenshot (1).png', 'Screenshot (1).png'),
(24, 127, 'ft8hg', 67867, 766897, 68, '0', '1', 'hgytugjut68d7otjhh876587ugj', 'Screenshot (1).png', 'Screenshot (1).png'),
(25, 127, 'yyi', 687, 768, 86, '10', '1', '87tujfyujykgfuiyuiykgvyfrutiuk', 'Screenshot (1).png', 'Screenshot (1).png'),
(27, 128, 'Aman Pilla', 500, 1, 2, '10', '1', 'Ye ek pilla h jo bhut hi bekar h.', 'Screenshot (4).png', 'Screenshot (2).png'),
(28, 129, 'ljuy', 86, 685786, 68, '10', '1', 'vhcdgnv6857ryfhgmn,mh7g68', 'Screenshot (5).png', 'Screenshot (6).png'),
(29, 124, 'mi note 4', 12245, 4364, 5, '10', '2', 'iytr7dygjkg875togljhvkf857r', 'Screenshot (4).png', 'Screenshot (5).png');
