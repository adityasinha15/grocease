			...
			<div class="privacy1">
				...
				<div class="banner-bottom-grid1 privacy1-grid">
					<ul>
						...
						<li><h5><b>Total Items:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><?php echo  $items[$j]; echo $i;?></h5><span></span></li><br>
						...
						<li><a href="../order_details.php?o_id=<?php echo $o_id[$j]; ?>&address_id=<?php echo $address_id[$j]; ?>&delivery_status=<?php echo $delivery_status[$j]; ?>"><button type="button" class="btn btn-info btn-lg">More Detail</button></a><span></span></li>
					</ul>
