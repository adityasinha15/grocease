...
<li class="postadd">
<a class="btn btn-danger btn-post" href="../../post-ads.html"><span class="fa fa-plus-circle"></span> Post an Ad</a></li>
</ul>
</div>
...
<h5 class="add-title"><a href="#">Gym</a></h5>
<div class="info">
...
<span class="category">Health & Fitness</span> 
...
<div class="col-sm-3 text-right  price-box"><button type="button" class="btn btn-success btn-sm">Read More</button>
<a class="btn btn-danger btn-sm" href="../education/tutions/sanjay-nagar/index.php"><i class="fa fa-certificate"></i>
<span>Go To Ads</span></a>
...
<div class="col-sm-7 add-desc-box">
<div class="add-details">
<h5 class="add-title"><a href="#">Dietitions</a></h5>
<div class="info">
<span class="add-type">B</span>
<span class="date">
<i class="fa fa-clock"></i>
...
<div class="col-sm-7 add-desc-box">
<div class="add-details">
<h5 class="add-title"><a href="#">Fitness Classes</a></h5>
<div class="info">
<span class="add-type">B</span>
<span class="date">
<i class="fa fa-clock"></i>
...
<div class="col-sm-7 add-desc-box">
<div class="add-details">
<h5 class="add-title"><a href="#">Yoga classes</a></h5>
<div class="info">
<span class="add-type">B</span>
<span class="date">
<i class="fa fa-clock"></i>
...
<div class="col-sm-7 add-desc-box">
<div class="add-details">
<h5 class="add-title"><a href="#">Health Food & Supplements</a></h5>
<div class="info">
<span class="add-type">B</span>
<span class="date">
<i class="fa fa-clock"></i>
...
<div class="col-sm-7 add-desc-box">
<div class="add-details">
<h5 class="add-title"><a href="#">Health Equipments</a></h5>
<div class="info">
<span class="add-type">B</span>
<span class="date">
<i class="fa fa-clock"></i>
...
<div class="col-sm-7 add-desc-box">
<div class="add-details">
<h5 class="add-title"><a href="#">Sports Club</a></h5>
<div class="info">
<span class="add-type">B</span>
<span class="date">
<i class="fa fa-clock"></i>
...
<div class="col-sm-7 add-desc-box">
<div class="add-details">
<h5 class="add-title"><a href="#">Meditation & Relaxation</a></h5>
<div class="info">
<span class="add-type">B</span>
<span class="date">
<i class="fa fa-clock"></i>
