...
if(isset($_SESSION['mid'])){
   ...
   echo "<script>alert('Your business is already registered'); window.location.assign('index.php');  </script>";
	}
	else{
...
<form role="form" name="myForm" action="register-business.php" onSubmit="return submit_validation()" method="post">
<div class="form-group">
<label class="control-label">Business Name <span id="important">*</span></label>
<input class="form-control" placeholder="Enter your business name" onKeyUp="b_check()" type="text" name="b_name" maxlength="80" required>
...
<input class="form-control" placeholder="Business Email" id="email" type="email" onKeyUp="ValidateEmail()" name="email" required>
...
<input class="form-control" id="Phone" placeholder="Contact Number" onKeyUp="num_check()" type="text" name="contact" maxlength="10" minlength="10" required>
...
<select name="cat" id="catselect" onChange="cattoscat()" class="form-control" required>
...
<textarea name="desc" rows="3" cols="100" placeholder="Describe your product or service (Atleast 20 character long)" style="max-width: 100%;" onKeyUp="desc_check()" required></textarea>
...
<input class="form-control" placeholder="Shop no." type="text" onKeyUp="shop_check()" name="shop_no" required>
...
<input class="form-control" placeholder="Block" type="text" onKeyUp="block_check()" name="block" required>
...
<input class="form-control" placeholder="Sector" type="text" onKeyUp="sector_check()" name="sector" required>
...
<div class="form-control"> <a class="link" href="#">Jhone.doe</a>
...
<button type="submit" class="btn btn-common btn-lg btn-block" name="b_register" id="registerok" >Submit</button>
