...
<h4 class="panel-title"> <a href="#collapseB1" data-toggle="collapse"><h3><strong>Update Products</strong> </h3></a> </h4>
</div>
<div class="panel-collapse collapse in" id="collapseB1">
<div class="panel-body">
<form role="form" name="myForm" action="update.php" onSubmit="return product_validation()" method="post">
<div class="form-group">
<label class="control-label">Product ID <span id="important">*</span></label>
<input class="form-control" placeholder="Enter your Product ID" type="number" name="pid" maxlength="80" value="<?php echo $_GET['pid']; ?>" disabled>
<?php
$_SESSION['pidupdate']=$_GET['pid'];	
?>
</div>
<div class="form-group">
<label class="control-label">Product Name <span id="important">*</span></label>
<input class="form-control" placeholder="Enter your Product name" type="text" name="p_name" maxlength="80">

</div>
<div class="form-group">
<label class="control-label">Product MRP <span id="important">*</span></label>
<input class="form-control" placeholder="Enter your Product MRP" type="number" name="mrp" maxlength="80">
</div>
<div class="form-group">
<label class="control-label">Selling Price <span id="important">*</span></label>
<input class="form-control" placeholder="Enter your Selling price" type="number" name="s_price" maxlength="80">
</div>
<div class="form-group">
<label class="control-label">Quantity of Product <span id="important">*</span></label>
<input class="form-control" placeholder="Enter product Quantity" type="number" name="quantity" maxlength="80">
</div>
<div class="form-group">
...
<textarea name="desc" rows="3" cols="100" style="max-width: 100%;" placeholder="Describe your product or service (Atleast 20 character long)" onKeyUp="desc_check()"></textarea>
...
<input id="input-b2" name="img1" type="file" class="file" onChange="img1_check()" data-show-preview="false">
...
<input id="input-b2" name="img2" type="file" class="file" onChange="img2_check()" data-show-preview="false">
...
<button type="submit" class="btn btn-common btn-lg btn-block" name="p_update" id="registerok" >Update Product</button>
